export const projects = [
  {
    ...
    year: 2024,
    description:
      "Plataforma de gestión logística integral para control de envíos, rutas y usuarios. Incluye panel de administración, seguimiento de pedidos en tiempo real, transiciones de estado y autenticación por roles.",
    technologies: ["React", "Node.js", "PostgreSQL", "Docker", "Express.js"],
    url: "https://tu-url-logistica.com",
    category: "Full Stack",
  },
  {
    id: 2,
